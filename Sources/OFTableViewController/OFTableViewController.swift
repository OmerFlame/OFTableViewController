...
open class OFTableViewController<T>: UIViewController {
    ...
    open func shouldFetchNextResults(tableView: UITableView, indexPath: IndexPath) -> Bool {
        if self.isFetching || self.nextPageLoaderCell == nil {
            return false
        }
    ...
    open func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if canShowNextPageLoaderCell(tableView: tableView, section: section) {
            return of_tableView(tableView, numberOfRowsInSection: section) + 1
        }
        
        return of_tableView(tableView, numberOfRowsInSection: section)
    }
    
    open func of_tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    ...
    open func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        return of_tableView(tableView, heightForRowAt: indexPath)
    }
    
    open func of_tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        return of_tableView(tableView, cellForRowAt: indexPath)
    }
    
    open func of_tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
